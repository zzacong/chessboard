...
import type { CapturedPieces, Difficulty, GameStatus, LastMove, PieceColor, PieceType } from '../types'
...
export function useChessGame(): UseChessGameReturn {
  ...
  const selectSquare = useCallback(
    ...
    [selectedSquare, legalMoveSquares, playerColor, difficulty, isComputerThinking, syncState, triggerComputerMove],
  )
