...
export function Board({
  ...
  return (
    <div className={`flex items-start gap-1 select-none${isComputerThinking ? ' cursor-wait' : ''}`}>
      {/* Rank labels left */}
      ...
      <div className="flex flex-col">
          ...
          {squares.map((sq, i) => {
            ...
            return (
              ...
              >
                ...
                {isLegal && (
                  <div className={isCapture ? 'legal-ring' : 'legal-dot'} />
                )}
                {PieceComp && (
                  <div
                    ...
                    style={{
                      width: '88%',
                      height: '88%',
                      ...(isSelected ? { transform: 'scale(1.1)', filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.5))' } : {}),
                    }}
                  >
                    <PieceComp size={44} />
                  </div>
        ...
        <div
          className="flex mt-1"
          style={{ width: 'calc(var(--sq-size) * 8)' }}
        >
          {fileLabels.map(f => (
            <span
              key={f}
